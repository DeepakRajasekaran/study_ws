...
#include "irobot_interfaces/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = irobot_interfaces::srv::ComputeRectangleArea_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irobot_interfaces::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<irobot_interfaces::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_irobot_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<irobot_interfaces::srv::ComputeRectangleArea_Request>()
{
  return &irobot_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = irobot_interfaces::srv::ComputeRectangleArea_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const irobot_interfaces::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<irobot_interfaces::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &irobot_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Response__handle;
}
...
{
  return &irobot_interfaces::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea__handle;
}
